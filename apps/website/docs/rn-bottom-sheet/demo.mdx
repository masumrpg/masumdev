...
## Try It Yourself
To get started with this component in your own project, check out our [installation guide](/docs/rn-bottom-sheet/installation) and [basic usage examples](/docs/rn-bottom-sheet/basic-usage).
