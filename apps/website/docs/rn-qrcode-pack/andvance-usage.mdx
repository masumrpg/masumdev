...
## Table of Contents
- [QRCode Generator](#qrcode-masumdevrn-qrcode-advanced-usage)
  - [Performance Optimization](#performance-optimization-tips)
  - [Best Practices](#best-practices)
  - [Styling & Customization](#styling)
    - [Design Principles](#design-principles)
    - [Built-in Variants](#variant-qrcode-builtin)
    - [Custom QR Code](#custom-qrcode)
  - [Advanced Features](#advanced-customization)
    - [Gradient Effects](#gradient-configuration)
    - [Eye Patterns](#advanced-eye-patterns)
    - [Error Handling](#error-handling-and-validation)
- [QRCode Scanner](#qrcodescanner-masumdevrn-qrcode-scanner-advanced-usage)
  - [Scanner Configuration](#scanner-configuration-best-practices)
  - [Advanced Features](#advanced-scanning-features)
  - [Implementation Examples](#advanced-scanner-implementation)
    - [Batch Scanning](#batch-scanning-with-validation)
    - [Custom UI](#customize-the-scanner-screen)
